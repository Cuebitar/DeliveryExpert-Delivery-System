...
public class TransactionList { // controller class for Delivery class
    ...
    public Delivery addDelivery(ArrayList<Delivery> deliveryList) {
        ...
        Delivery newDelivery = new Delivery(str.toString(), staff.getId(), client.getId(), receiverName, receiverTelNo, String.valueOf(deliveryID),
                String.valueOf(sameDayDelivery), String.valueOf(withInsurance), pickUpLocation, dropOffLocation, date.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
